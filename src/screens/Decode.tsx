...
import { decodeFromMorse } from '../utils/morseUtils';
...
const Decode = () => {
  ...
  const handleDecode = () => {
    Keyboard.dismiss();
    setResult(decodeFromMorse(text));
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContainer}>
        ...
        <TouchableOpacity style={styles.buttonstyle} onPress={handleDecode}>
      ...
      <Dialog.Container style={styles.dialogContainer} visible={visible} onBackdropPress={handleCloseDialog}>
        ...
        <Dialog.Description style={styles.dialogDescription}>
          The text converted from Morse code has been copied to the clipboard. ✅
        </Dialog.Description>
        <Dialog.Button
          label="OK"
